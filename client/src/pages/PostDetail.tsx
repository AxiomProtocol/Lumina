            ...
            {post.postType === "music" && (post as any).linkedMusicTrack && (
              <div className="rounded-xl border border-border/50 bg-muted/30 p-4 mb-4 space-y-3" data-testid="music-post-player">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-base font-semibold">{(post as any).linkedMusicTrack.title}</span>
                </div>
                {(post as any).linkedMusicTrack.description && (
                  <p className="text-sm text-muted-foreground">{(post as any).linkedMusicTrack.description}</p>
                )}
                <audio
