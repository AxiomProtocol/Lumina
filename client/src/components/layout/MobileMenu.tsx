...
import { X, Home, Play, Users, User, Settings, TrendingUp, Coins, Search, MessageCircle, BarChart3, Trophy, Radio, ShoppingBag, ImageIcon, Vote, Lock, Award, Megaphone, Hand, ClipboardList, Phone, Shield, Building2, Gift, GraduationCap, ArrowDownUp, Server, ArrowLeftRight, FileText, Wallet, Store, Bug, Rocket, Sparkles } from "lucide-react";
...
const mainNavItems = [
  ...
  { href: "/creation-hub", label: "Creation Hub", icon: Sparkles },
];
